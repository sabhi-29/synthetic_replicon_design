...
def scrape_plasmids(html_content: str) -> list[dict[str, str]]:
  """https://www.addgene.org/browse/article/5455/
...
def scrape_plasmids_id(html_content: str) -> list[dict[str, str]]:
  """
  Scrape list of plasmids from Addgene HTML content.
  ...
  Returns:
  list: a list of dictionaries containing plasmid data only ids.
  """
